 ...
 *  @generated
 */
library xkcm.src.version_exception;

import 'dart:typed_data' show Uint8List;
import 'package:thrift/thrift.dart';
import 'package:xkcm/xkcm.dart';

class VersionException implements TBase, Exception  {
  static final TStruct _STRUCT_DESC = new TStruct("VersionException");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("VersionException(");
