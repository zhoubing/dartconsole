 ...
 *  @generated
 */
library xkcm.src.auth_exception;

import 'dart:typed_data' show Uint8List;
import 'package:thrift/thrift.dart';
import 'package:xkcm/xkcm.dart';

class AuthException implements TBase, Exception  {
  static final TStruct _STRUCT_DESC = new TStruct("AuthException");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("AuthException(");
