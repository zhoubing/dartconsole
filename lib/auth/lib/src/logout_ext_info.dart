 ...
 *  @generated
 */
library auth.src.logout_ext_info;
...
class LogoutExtInfo implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("LogoutExtInfo");
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("LogoutExtInfo(");
